...
from .views.discoveryGenerationViews import DiscoveryGenerateView
...
urlpatterns = [
    ...
    path('generate-from-genre/', DiscoveryGenerateView.as_view()),
    path("generate-from-prompt/", GenerateQueueFromPromptView.as_view(), name="queue-from-prompt"),

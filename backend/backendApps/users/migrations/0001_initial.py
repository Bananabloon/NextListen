        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "typeOfMedia",
                    models.CharField(
                        choices=[("song", "Song"), ("album", "Album")], max_length=10
                    ),
                ),
                ...
                (
                    "genreName",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="users.genre"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "media",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="users.media"
                    ),
                ),
                (
                    "user",
